...
# updating vars
competition_cloud_host_cost_usd_per_month=initial_competition_cloud_host_cost_usd_per_month
blockchain_miner_host_cost_usd_per_month=initial_blockchain_miner_host_cost_usd_per_month
current_nodes=initial_nodes
current_gas_price_hvt=initial_gas_price_hvt
current_hvt_price_usd=initial_hvt_price_usd
